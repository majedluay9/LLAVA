...
class CsvProcessor(object):
    ...
    def plot_by_resolution(self, res,res_big , name=''):
        if not os.path.exists(name):
            os.makedirs(name)
        binned = self.bin_by_resolution(res,res_big)
...
if __name__ == '__main__':
    ...
    csv_processor_ip.plot_by_resolution(RES_SMALL,RES_BIG, name=output_dir_ip)
